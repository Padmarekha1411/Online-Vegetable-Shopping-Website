<!DOCTYPE html>
<%@page import="com.example.VegFoodProject.bean.Fruits"%>
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('images/bg_1.jpg');">
     ...
     <section class="ftco-section">
    	<div class="container">
    		...
    		<% List<Fruits> fruit = (List)request.getAttribute("fruitlist");
            
            for(Fruits f:fruit){%>
    		
    			<div id="" data-tab-content class="col-md-6 col-lg-3">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="<%=f.getImage()%>" alt="Colorlib Template">
    						
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#"><%=f.getName() %></a></h3>
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span class="price-sale">$<%=f.getPrice() %></span></p>
		    					</div>
	    					</div>
	    					<div class="bottom-area d-flex px-3">
	    						<div class="m-auto d-flex">
	    							...
	    							<a href="productview?id=<%=f.getId() %>&image=<%=f.getImage() %>&name=<%=f.getName() %>&price=<%=f.getPrice() %>" class="add-to-cart d-flex justify-content-center align-items-center text-center">
                         ...
                         if(r2!=null){%>
                        <a href="cart?id=<%=f.getId() %>&image=<%=f.getImage() %>&name=<%=f.getName() %>&price=<%=f.getPrice() %>&uid=<%=register.getEmail() %>" class="buy-now d-flex justify-content-center align-items-center mx-1">
                        ...
                        <%}else{%>
                         ...
                         if(r3!=null){%>
	    							...
	    							<a href="wishlist?id=<%=f.getId() %>&image=<%=f.getImage() %>&name=<%=f.getName() %>&price=<%=f.getPrice() %>&wid=<%=register.getEmail() %>" class="heart d-flex justify-content-center align-items-center ">
