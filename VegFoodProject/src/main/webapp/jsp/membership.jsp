 ...
 <body class="goto-here">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span> <span>Membership Program</span></p>
            <h1 class="mb-0 bread">Membership Program</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section contact-section bg-light">
      ...
      <span>
        ...
        <div class="rte">
      <p>Join our <strong>Membership Program</strong> and get access to a bunch of <strong>Exclusive Benefits</strong>. Here's what awaits you:</p>
<p><strong>Fruitful Discounts: 10% discount</strong> on <strong>every order</strong></p>
<p><strong>Delivered with love and no charge: Free Delivery</strong> on all your orders</p>
<p>Don't miss out on these exclusive perks at <strong>Rs.599</strong> for <strong>3 months!</strong></p>
<p>Simply fill up the form linked below or text us on Whatsapp: <a href="https://wa.me/+917666908500">https://wa.me/+917666908500</a></p>
<p><a href="https://forms.gle/fPBJzQThWUJjj639A">https://forms.gle/fPBJzQThWUJjj639A</a></p>
    </div>
