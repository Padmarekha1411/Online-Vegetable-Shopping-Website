      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-7 ftco-animate">
						<form action="billing_details" method="post" class="billing-form">
                ...
                <div class="w-100"></div>
		            ...
		            <div class="col-md-6">
		            	<div class="form-group">
	                  <input type="text" class="form-control" placeholder="Appartment, suite, unit etc: (optional)" name="address">
	                </div>
		            </div>
		            <div class="w-100"></div>
		            <div class="col-md-6">
	          ...
	          <div class="row mt-5 pt-3">
	          	...
	          	<div class="col-md-12">
	          		...
	          		<form action="billing_details" method="post">
	          			<h3 class="billing-heading mb-4">Payment Method</h3>
									<div class="form-group">
										<div class="col-md-12">
											<div class="radio">
											   <label><input type="radio" name="payment_method" class="mr-2"> Direct Bank Tranfer</label>
											</div>
										</div>
									</div>
									<div class="form-group">
