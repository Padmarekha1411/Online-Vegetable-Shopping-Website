...
<%@page import="com.example.VegFoodProject.bean.Cart"%>
	    				...
	    				<table class="table">
						    ...
						    <tbody>
						      ...
						      <tr class="text-center">
						        ...
						        <td>
						       <button type="submit">
						       <input type = "hidden" name="prices" value = "<%=c.getPrice() %>">
						       <input type = "hidden" name="name" value = "<%=c.getName() %>">
						       <div class="wrap-num-product flex-w m-l-auto m-r-0">
											<div class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m">
												<i class="ion-ios-remove"></i>
											</div>
											<%Integer s=(Integer)session.getAttribute("price");%>
											<%Integer s1=(Integer)session.getAttribute("quantity");%>
											<%String s2=(String)session.getAttribute("name");%>
											<%if (s1==null && c.getName()!= s2) { %>
											<input class="mtext-104 cl3 txt-center num-product" type="number" name="quantity" value="1" >
											<%} else {%>
											<input class="mtext-104 cl3 txt-center num-product" type="number" name="quantity" value="<%=s1 %>" >
											<%} %>
						        ...
						        <%if (s==null) { %>
						        <td class="total">$<%=c.getPrice() %></td>
						        <%} else {%>
						        <td class="total">$<%=s %></td>
						         <%} %>
						        <td class="product-remove"><a href="delete?id=<%=c.getId()%>"> <span class="ion-ios-trash"></span></a></td>
						      </form>
						      </tr><!-- END TR-->
