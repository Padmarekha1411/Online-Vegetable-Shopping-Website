 ...
 <body class="goto-here">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span> <span>BULK/EXPORT QUERIES</span></p>
            <h1 class="mb-0 bread">BULK/EXPORT QUERIES</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section contact-section bg-light">
      ...
      <span>
       ...
       <div class="rte">
      <p><strong>Our goal here at Fresh India Organics is to make organic produce easily accessible and affordable at all levels- whether that be your household or a restaurant that you own. </strong></p>
<p>In addition to meeting your everyday household requirements, we are also happy to help those looking for organic fruits and vegetables required in bulk- whether for your <strong>restaurants, events, pop-up shops, for gifting or even for export. </strong></p>
<p>Simply fill out the form below and someone from our team will reach out to you <strong>within 24 hours</strong>. You can also contact at&nbsp;<span>enquiry@freshindiaorganics.com.</span></p>
...
<div style={ background-color: #f4f4f4;
            ...
            height: 100vh;
            margin: 0% 31.5%;}>
   <form action="fio_partner" method="post" onsubmit="return validateForm()">
        <h2>Become An FIO Partner</h2>
        <label for="businessName" >Full Name:</label>
        <input type="text" id="businessName" name="full_name" required>
