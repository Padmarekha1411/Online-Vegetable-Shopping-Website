<!DOCTYPE html>
<%@page import="com.example.VegFoodProject.bean.Product_View"%>
...
<html lang="en">
  ...
  <body class="goto-here">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index">Home</a></span> <span class="mr-2"><a href="index">Product</a></span></p>
            <h1 class="mb-0 bread">Product View</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <% All_Veg p=(All_Veg)session.getAttribute("product"); 
    int sum=0,count=0;
    if(p!=null){
    	   %>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="images/product-1.jpg" class="image-popup"><img src="<%=p.getImage() %>" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
          	...
          	<p><a href="cart?id=<%=p.getId() %>&image=<%=p.getImage() %>&name=<%=p.getName() %>&price=<%=p.getPrice() %>&uid=<%=register.getEmail() %>" class="btn btn-black py-3 px-5">Add to Cart</a></p>
          	
          	<%}else{%>
          	
          	<p><a href="registration" class="btn btn-black py-3 px-5">Add to Cart</a></p>
